...
<script>
import TopClient from "../../../layout/components/Client/TopClient.vue";
import MenuClient from "../../../layout/components/Client/MenuClient.vue";
import BotClient from "../../../layout/components/Client/BotClient.vue";
