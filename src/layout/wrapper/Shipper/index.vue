<template>
    <div class="wrapper">
        ...
        <BotShipper></BotShipper>
	</div>
</template>
<script>
import TopShipper from "../../../layout/components/Shipper/TopShipper.vue";
import MenuShipper from "../../../layout/components/Shipper/MenuShipper.vue";
import BotShipper from "../../../layout/components/Shipper/BotShipper.vue";
...
export default {
    name        :   "app",
    components  :   {
        TopShipper, MenuShipper, BotShipper
    }
}
</script>
<style>
