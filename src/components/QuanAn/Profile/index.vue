                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="d-flex flex-column align-items-center text-center">
                                    ...
                                    <div class="mt-3">
                                        <h4>{{ user.ten_quan_an }}</h4>
                                        <p class="text-secondary mb-1">Quán Ăn</p>
                            ...
                            <div class="card-body">
                                <div class="border rounded-3 p-4 mb-4">
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-sm-9">
                                            <input v-model="user.ten_quan_an" type="text" class="form-control">
                                        </div>
                                    </div>
                                    <div class="row mb-3">
                                        <div class="col-sm-3">
                                ...
                                <div class="border rounded-3 p-4">
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-sm-9">
                                            <input v-model="doi_mat_khau.password" type="password" class="form-control"
...
export default {
    ...
    methods: {
        ...
        updateProfile() {
            axios
                .post("http://127.0.0.1:8000/api/quan-an/update-profile", this.user, {
                    headers: {
                        Authorization: "Bearer " + localStorage.getItem("quan_an_login"),
                    },
                })
