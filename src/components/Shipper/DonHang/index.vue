<template>
  <div class="container-fluid mt-3">
    <div class="row mb-4">
      <div class="col-12">
        <div class="card border-0 shadow rounded-4 bg-primary">
          <div class="card-body p-4">
            <div class="d-flex justify-content-between align-items-center flex-wrap">
              <div class="d-flex align-items-center gap-4">
                <div>
                  <h1 class="h3  text-white mb-1">Quản lý đơn hàng</h1>
                  <p class="mb-0 text-white">Xem và quản lý đơn hàng của bạn</p>
                </div>
              </div>
              <div class="d-flex align-items-center gap-3 mt-3 mt-md-0">
                <div class="text-end">
                  <h6 class="mb-0 text-white">Nguyễn Văn A</h6>
                  <small class="text-white">Shipper #12345</small>
                </div>
                <div class="rounded-circle bg-white bg-opacity-25 d-flex align-items-center justify-content-center">
                  <img style="width: 60px; height: 60px; object-fit: cover; border-radius: 50%;" class="img-fluid"
      ...
      <div class="card-body p-3">
        <div class="row g-3">
          ...
          <div class="col-lg-2 col-sm-6">
            <button class="btn btn-primary w-100 " style="padding-top: 0.375rem; padding-bottom: 0.375rem;">
              Lọc
            </button>
          </div>
        </div>
      ...
      <div class="tab-pane fade show active" id="available">
        <div class="row ">
          <div class="col-lg-4">
            <div class="card h-100 ">
              <div class="card-header bg-warning d-flex justify-content-between align-items-center">
                <span><b class="text-white">#ORD-5829</b></span>
                <span class="badge bg-success text-white">Có thể nhận</span>
              </div>
              <div class="card-body">
                <div class="d-flex mb-3">
                  <div class="me-3">
                    <img style="width: 100px; height: 100px; object-fit: cover; border-radius: 50%;" class="img-fluid"
                      src="https://cdn.brvn.vn/editor_news/2020/02/19933_Pho24_2_1582541813.jpg" alt="">
                  </div>
                  <div>
                    <h6 class="mt-2">Nhà hàng Phở 24</h6>
                    <p class="text-muted mb-0 small">123 Nguyễn Văn Linh, Quận 7</p>
                    <div class="small text-success">Mở cửa • 2.5km từ vị trí của bạn</div>
                  </div>
                </div>
                <div class="d-flex mb-3">
                  <div class="me-3">
                    <img style="width: 100px; height: 100px; border-radius: 50%;" class="img-fluid"
                      src="https://w7.pngwing.com/pngs/661/914/png-transparent-woman-female-avatar-business-avatar-icon.png"
                      alt="">
                  </div>
                  <div>
                    <h6 class="mt-2">Nguyễn Thị B</h6>
              ...
              <div class="card-footer bg-white">
                <div class="d-flex justify-content-between">
                  <span class="text-muted small"><i class="bi bi-clock me-1"></i> Đặt 10 phút trước</span>
                  <div>
                    <button class="btn btn-outline-primary ">Chi tiết</button>
                    <button class="btn btn-success  ms-2">Nhận đơn</button>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div class="col-lg-4">
            <div class="card h-100 ">
              <div class="card-header bg-warning d-flex justify-content-between align-items-center">
                ...
                <span class="badge bg-success">Có thể nhận</span>
              </div>
              <div class="card-body">
                <div class="d-flex mb-3">
                  <div class="me-3">
                    <img style="width: 100px; height: 100px; object-fit: cover; border-radius: 50%;" class="img-fluid"
                      src="https://statics.vincom.com.vn/xu-huong/nha-hang-sushi/Kohaku-nha-hang-sushi.jpg" alt="">
                  </div>
                  <div>
                    <h6 class="mt-2">Nhà hàng Sushi Nhật Bản</h6>
                    <p class="text-muted mb-0 small">45 Lê Thánh Tôn, Quận 1</p>
                    <div class="small text-success">Mở cửa • 2.1km từ vị trí của bạn</div>
                  </div>
                </div>
                ...
                <div class="d-flex justify-content-between border-top pt-3">
                  <div>
                    <span class="d-block">Giá trị đơn hàng:</span>
                    <span class="fw-bold text-success">450.000đ</span>
                  </div>
                  <div>
                    <span class="d-block">Phí vận chuyển:</span>
                    <span class="fw-bold text-primary">35.000đ</span>
              ...
              <div class="card-footer bg-white">
                <div class="d-flex justify-content-between">
                  <span class="text-muted small"><i class="bi bi-clock me-1"></i> Đặt 8 phút trước</span>
                  <div>
                    <button class="btn btn-outline-primary ">Chi tiết</button>
                    <button class="btn btn-success  ms-2">Nhận đơn</button>
                  </div>
          ...
          <div class="col-lg-4">
            <div class="card h-100 ">
              <div class="card-header bg-warning d-flex justify-content-between align-items-center">
                <span class="fw-bold text-white">#ORD-5426</span>
                <span class="badge bg-success">Có thể nhận</span>
              </div>
              <div class="card-body">
                <div class="d-flex mb-3">
                  <div class="me-3">
                    <img style="width: 100px; height: 100px; object-fit: cover; border-radius: 50%;" class="img-fluid"
                      src="https://welcome.deliveryk.com/wp-content/uploads/2023/12/deliveryk-thit-nuong-han-quoc-o-da-nang-5.jpg" alt="">
                  </div>
                  <div>
                    <h6 class="mt-2">Nhà hàng BBQ Hàn Quốc</h6>
                    <p class="text-muted mb-0 small">45 Lê Thánh Tôn, Quận 1</p>
                    <div class="small text-success">Mở cửa • 2.1km từ vị trí của bạn</div>
                  </div>
                </div>
            ...
            <div class="card h-100 border-warning">
              ...
              <div class="card-body">
                <div class="d-flex mb-3">
                  ...
                  <div>
                    <h6 class="mt-2">Bún Đậu Mắm Tôm A Chảnh</h6>
                    <p class="text-muted mb-0 small">94 Nguyễn Du, Quận 1</p>
                    <div class="small text-warning"><i class="bi bi-hourglass-split me-1"></i> Đang lấy hàng</div>
                  </div>
                </div>
                <div class="d-flex mb-3">
                  <div class="me-3">
                  ...
                  <div>
                    <h6 class="mt-2">Trân Văn A</h6>
                    <p class="text-muted mb-0 small">35 Trần Hưng Đạo, Quận 5</p>
                    <div class="small text-muted"><i class="bi bi-clock-history me-1"></i> Chờ lấy hàng</div>
                  </div>
                </div>
              ...
              <div class="card-footer bg-white">
                <div class="d-flex justify-content-between">
                  <span class="text-muted small"><i class="bi bi-clock me-1"></i> Nhận đơn 20 phút trước</span>
                  <div>
            ...
            <div class="card h-100 border-warning">
              ...
              <div class="card-body">
                <div class="d-flex mb-3">
                  ...
                  <div>
                    <h6 class="mt-2">Cháo Lòng Hà Còi</h6>
                    <p class="text-muted mb-0 small">94 Nguyễn Du, Quận 1</p>
                    <div class="small text-warning"><i class="bi bi-hourglass-split me-1"></i> Đang lấy hàng</div>
                  </div>
                </div>
              ...
              <div class="card-footer bg-white">
                <div class="d-flex justify-content-between">
                  <span class="text-muted small"><i class="bi bi-clock me-1"></i> Nhận đơn 10 phút trước</span>
                  <div>
                    <button class="btn btn-outline-warning ">Đã lấy hàng</button>
                    <button class="btn btn-outline-danger  ms-2">Gặp vấn đề</button>
                  </div>
            ...
            <div class="card h-100 border-warning">
              ...
              <div class="card-body">
                <div class="d-flex mb-3">
                  ...
                  <div>
                    <h6 class="mt-2">Phở Hoà Pasture</h6>
                    <p class="text-muted mb-0 small">94 Nguyễn Du, Quận 1</p>
                    <div class="small text-warning"><i class="bi bi-hourglass-split me-1"></i> Đang lấy hàng</div>
                  </div>
                </div>
                <div class="d-flex mb-3">
                  <div class="me-3">
                    <img style="width: 100px; height: 100px; object-fit: cover; border-radius: 50%;" class="img-fluid"
                      src="https://w7.pngwing.com/pngs/661/914/png-transparent-woman-female-avatar-business-avatar-icon.png" alt="">
                  </div>
                  <div>
                    <h6 class="mt-2">Nguyễn Thị B</h6>
                ...
                <div class="progress mb-3" style="height: 8px;">
                  <div class="progress-bar bg-success" role="progressbar" style="width: 60%;" aria-valuenow="40"
                    aria-valuemin="0" aria-valuemax="100"></div>
                </div>
                <div class="d-flex justify-content-between mb-3">
                  <div class="text-center">
              ...
              <div class="card-footer bg-white">
                <div class="d-flex justify-content-between">
                  <span class="text-muted small"><i class="bi bi-clock me-1"></i> Nhận đơn 30 phút trước</span>
                  <div>
              ...
              <div class="card-body">
                <div class="restaurant-info d-flex align-items-center mb-4">
                  <div class="restaurant-image me-3">
                    <img
                      src="https://st.nhipcaudautu.vn/staticFile/Subject/2024/06/24/processed-30cb0c56-9519-4d0e-8ea3-e0fe86135b4a_58erc59t_11022882.jpeg"
                      class="rounded-3 shadow-sm" style="width: 100px; height: 100px; object-fit: cover;" alt="">
                  </div>
                ...
                <div class="delivery-info bg-light rounded-4 p-3 mb-4">
                  <div class="d-flex align-items-center">
                    <div class="customer-avatar me-3">
                      <img
                        src="https://png.pngtree.com/png-vector/20220630/ourmid/pngtree-woman-with-glasses-user-vector-png-image_5322589.png"
                        class="rounded-circle shadow-sm" style="width: 50px; height: 50px; object-fit: cover;" alt="">
                    </div>
          ...
          <div class="col-lg-4">
            <div class="card h-100 border-0 shadow-sm hover-shadow">
              ...
              <div class="card-body">
                <div class="restaurant-info d-flex align-items-center mb-4">
                  <div class="restaurant-image me-3">
                    <img src="https://i.ytimg.com/vi/PSlxC2yJm-U/maxresdefault.jpg" class="rounded-3 shadow-sm"
          ...
          <div class="col-lg-4">
            <div class="card h-100 border-0 shadow-sm hover-shadow">
              ...
              <div class="card-body">
                <div class="restaurant-info d-flex align-items-center mb-4">
                  <div class="restaurant-image me-3">
                    <img src="https://daivietourist.vn/wp-content/uploads/2024/10/banh-trang-cuon-thit-heo-4.jpg" class="rounded-3 shadow-sm"
                      style="width: 100px; height: 100px; object-fit: cover;" alt="">
                  </div>
                  <div class="restaurant-details">
