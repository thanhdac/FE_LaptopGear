        ...
        <div class="col-lg-12">
            <div class="card radius-10 border-top border-0 border-3 border-info">
                <div class="card-header d-flex justify-content-between">
                    <h4 class="mt-2"><b>DANH SÁCH DANH MỤC</b></h4>
                ...
                <div class="card-body table-responsive">
                    <div class="input-group mb-3">
                        ...
                        <button class="btn btn-success input-group-text" style="width: 110px">
                            Tìm kiếm
                        </button>
                    </div>
                                ...
                                <template v-for="(item, index) in list_danh_muc" :key="index">
                                    <tr>
                                        ...
                                        <td @click="doiTrangThai(item)" class="align-middle text-center text-nowrap"
                                            style="width: 140px">
                                            <button v-if="item.trang_thai == 0" class="btn btn-danger w-100"
                                                style="color: white">
                                                Tạm tắt
                                            </button>
                                            <button v-if="item.trang_thai == 1" class="btn btn-warning w-100"
                                                style="color: white">
                                                Hoạt động
                                            </button>
                                        </td>
                ...
                <div class="modal-body">
                    <div class="row">
                        ...
                        <div class="col-md-3 mb-3">
                            ...
                            <select v-model="create_danh_muc.tinh_trang" class="form-select">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="alert alert-danger" role="alert">
                        Bạn có chắc chắn muốn xóa dnah mục
