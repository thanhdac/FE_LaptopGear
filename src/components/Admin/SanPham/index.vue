    ...
    <div class="col-lg-12">
      <div class="card radius-10 border-top border-0 border-3 border-info">
        <div class="card-header d-flex justify-content-between">
          <h4 class="mt-2"><b>DANH SÁCH SẢN PHẨM</b></h4>
...
export default {
  ...
  methods: {
    ...
    themSanPham() {
      axios.post("http://127.0.0.1:8000/api/admin/san-pham/add-data", this.create_san_pham)
      .then((res) => {
        if (res.data.status) {
    ...
    capNhapSanPham() {
      axios.post("http://127.0.0.1:8000/api/admin/san-pham/update", this.edit_san_pham)
      .then((res) => {
        if (res.data.status) {
          this.$toast.success(res.data.message);
          this.getSanPham();
    ...
    xoaSanPham() {
      axios.post("http://127.0.0.1:8000/api/admin/san-pham/delete", this.del_san_pham)
      .then((res) => {
        if (res.data.status) {
          this.$toast.success(res.data.message);
          this.getSanPham();
